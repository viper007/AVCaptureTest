...
- (void)viewDidLoad {
    ...
    self.sessionQueue = dispatch_queue_create("session queue", DISPATCH_QUEUE_SERIAL);//创建一个串行的队列，不允许多个线程同时连接，所以为串行的队列
...
#pragma mark --Private 
- (UIButton *)buttonWithTitleName:(NSString *)titleName {
